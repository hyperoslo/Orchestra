  ...
  static var projects: [Project] {
    return [
      Project(id: 0, name: "Whisper",
        ...
        imageURL: NSURL(
          string: "https://github.com/hyperoslo/Whisper/blob/master/Resources/whisper-cover.png")!,
      ...
      Project(id: 0, name: "ImagePicker",
        ...
        imageURL: NSURL(
          string: "https://github.com/hyperoslo/ImagePicker/blob/master/Resources/ImagePickerIcon.png")!,
      ...
      Project(id: 0, name: "Compass",
        ...
        imageURL: NSURL(
          string: "https://raw.githubusercontent.com/hyperoslo/Compass/master/Images/logo_v1.png")!,
